"""
Merupakan 'otak' yang mengatur bagaimana perilaku agent
menggunakan Q-Learning
...
class RL:
    def __init__(self, actions, states):
        ...
        # create the Q-table (index:36 states   columns: 4 actions)
        self.q_table = pd.DataFrame(np.zeros((36, 4)), index=self.states, columns=self.actions, dtype=np.float64)
...
class QLearningTable(RL):
    ...
    def update_table(self, s, a, r, s_):
        ...
        if s_ != [150, 150] or s_ != [550, 150] or s_ != [150, 350] or s_ != [450, 350] or s_ != [150, 250] or s_ != [250, 450] or s_ != [250, 350] or s_ != [350, 50] or s_ != [350, 150]:
