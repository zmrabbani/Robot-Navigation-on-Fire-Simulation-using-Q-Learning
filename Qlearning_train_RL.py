"""
Proses training Q-learning

Butuh 125 detik untuk menyelesaikan 800 episode
success rate : 81.62%
The shortest route: 8
The longest route: 59
"""
from env_RL import Environment
from agent_brain_RL import QLearningTable
import time
...
def train():
    ...
    for episode in range(800):
        ...
        while True:
            ...
            if env.next_state == [350, 550]:             # when agent reach the goal coordinate
...
if __name__ == "__main__":
    ...
    RL = QLearningTable(actions=[0, 1, 2, 3],
                        states=['[50.0, 50.0]', '[50.0, 150.0]', '[50.0, 250.0]', '[50.0, 350.0]', '[50.0, 450.0]', '[50.0, 550.0]',
                                '[150.0, 50.0]', '[150.0, 150.0]', '[150.0, 250.0]', '[150.0, 350.0]', '[150.0, 450.0]', '[150.0, 550.0]',
                                '[250.0, 50.0]', '[250.0, 150.0]', '[250.0, 250.0]', '[250.0, 350.0]', '[250.0, 450.0]', '[250.0, 550.0]',
                                '[350.0, 50.0]', '[350.0, 150.0]', '[350.0, 250.0]', '[350.0, 350.0]', '[350.0, 450.0]', '[350.0, 550.0]',
                                '[450.0, 50.0]', '[450.0, 150.0]', '[450.0, 250.0]', '[450.0, 350.0]', '[450.0, 450.0]', '[450.0, 550.0]',
                                '[550.0, 50.0]', '[550.0, 150.0]', '[550.0, 250.0]', '[550.0, 350.0]', '[550.0, 450.0]', '[550.0, 550.0]'],)
    env.after(800, train)
    env.mainloop()
